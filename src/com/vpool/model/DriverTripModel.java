...
public class DriverTripModel extends ActionSupport implements Serializable{
	int tripID, driverID, vehicleID, fareDriverTotal, fareCash, driverShare;
	String source, destination, expectedTimeOfArrival, expectedTimeOfDestination, createdOn, startTime, endTime, status;
